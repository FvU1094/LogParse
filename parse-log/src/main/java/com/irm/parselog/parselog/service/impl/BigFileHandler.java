...
public class BigFileHandler {
	...
	private BigFileHandler(File file,FileHandler handle,String charset,int bufferSize,int threadSize){
		...
		startEndPairs = new HashSet<BigFileHandler.StartEndPair>();
	}
	...
	public static class Builder{
		...
		public BigFileHandler build(){
			return new BigFileHandler(this.file,this.handle,this.charset,this.bufferSize,this.threadSize);
		}
	}
